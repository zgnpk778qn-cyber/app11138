...
# 目标单字集合
TARGET_CHARS = sorted(set(
    '确认是否对错完成未提交定取消保存删除编辑添加搜索返回'
    '下一步知道了允许拒绝同意开始结束登录注册发送购买支付'
    '立即领取关闭了解好的请输入选择查看详情更多设置我的首页'
    '消息通知评论点赞分享关注粉丝动态活动优惠券红包奖励任务'
    '签到打卡抽奖竞猜排名成绩继续退出暂停重置刷新加载中'
))

# 目标词语列表（按长度降序）
TARGET_WORDS = sorted([
    '确认', '取消', '完成', '未完成', '提交', '确定', '保存', '删除',
    '编辑', '添加', '搜索', '返回', '下一步', '知道了', '允许', '拒绝',
    '同意', '开始', '结束', '登录', '注册', '发送', '购买', '支付',
    '立即购买', '立即领取', '立即', '领取', '关闭', '了解', '好的',
    '请输入', '选择', '查看详情', '查看', '详情', '更多', '设置',
    '我的', '首页', '消息', '通知', '评论', '点赞', '分享', '关注',
    '粉丝', '动态', '活动', '优惠券', '红包', '奖励', '任务', '签到',
    '打卡', '抽奖', '竞猜', '排名', '成绩', '继续', '退出', '暂停',
    '是', '否', '对', '错', '重置', '刷新', '加载中', '加载',
